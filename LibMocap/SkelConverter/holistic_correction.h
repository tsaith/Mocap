...
//#include "body_capsule.hpp"
#include "math_utils.h"
#include "head_stabilizer.h"
#include "hand_stabilizer.h"
#include "db_utils.h"
#include "timer.hpp"
...
private:
    ...
    // Kalman filter
    kf::Kalman1d mPoseKalman[POSE_LANDMARK_NUM][3];
    kf::Kalman1d mLeftHandKalman[HAND_LANDMARK_NUM][3];
    kf::Kalman1d mRightHandKalman[HAND_LANDMARK_NUM][3];
    kf::Kalman1d mFacemeshKalman[FACEMESH_LANDMARK_NUM][3];
    kf::Kalman1d mDepthKalman;
    ...
    // Timers
    Timer mDebugTimer = Timer();
    Timer mFilterTimer = Timer();
